...
namespace Client.Scripts.Shapes
{
    public class StarredHoledShape : Shape
    {
        ...
        public StarredHoledShape(ShapeProperties shapeProperties) : base(shapeProperties)
        {
        ...
        public override Mesh CreateMesh()
        {
            ...
            for (var i = 0; i < _localVertexCount; i++)
            {
                ...
                verts[_localVertexCount * 2 + i * 2] = outerVertCoordinate * _holeSize;
                verts[_localVertexCount * 2 + i * 2 + 1] = innerVertCoordinate * _holeSize;
